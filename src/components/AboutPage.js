        ...
        <div className="flex justify-between items-center max-w-7xl mx-auto">
          ...
          <div className="flex items-center space-x-3 md:space-x-4 lg:space-x-6">
            <div className="hidden sm:flex space-x-3 md:space-x-4">
              <Link to="https://instagram.com/superlovefilm" className="hover:text-gray-300 transition-colors">
              ...
              <Link to="https://vimeo.com/superlovefilm" className="hover:text-gray-300 transition-colors">
                <svg className="w-4 h-4 md:w-5 md:h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M23.977 6.416c-.105 2.338-1.739 5.543-4.894 9.609-3.268 4.247-6.026 6.37-8.29 6.37-1.409 0-2.578-1.294-3.553-3.881L5.322 11.4C4.603 8.816 3.834 7.522 3.01 7.522c-.179 0-.806.378-1.881 1.132L0 7.197c1.185-1.044 2.351-2.084 3.501-3.128C5.08 2.701 6.266 1.984 7.055 1.91c1.867-.18 3.016 1.1 3.447 3.838.465 2.953.789 4.789.971 5.507.539 2.45 1.131 3.674 1.776 3.674.502 0 1.256-.796 2.265-2.385 1.004-1.589 1.54-2.797 1.612-3.628.144-1.371-.395-2.061-1.614-2.061-.574 0-1.167.121-1.777.391 1.186-3.868 3.434-5.757 6.762-5.637 2.473.06 3.628 1.664 3.493 4.797l-.013.01z" />
                </svg>
              </Link>
              <Link to="https://tiktok.com/@superlovefilm" className="hover:text-gray-300 transition-colors">
                <svg className="w-4 h-4 md:w-5 md:h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          >
            ...
            <div className="space-y-8">
              ...
              <div className="flex justify-center space-x-8">
                <Link
                  to="https://instagram.com/superlovefilm"
                ...
                <Link
                  to="https://vimeo.com/superlovefilm"
                  className="text-white hover:text-gray-300 transition-colors"
                  onClick={() => setIsMobileMenuOpen(false)}
                >
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                ...
                <Link
                  to="https://tiktok.com/@superlovefilm"
                  className="text-white hover:text-gray-300 transition-colors"
                  onClick={() => setIsMobileMenuOpen(false)}
                >
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
